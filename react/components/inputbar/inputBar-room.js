...
import styles from './inputBar-room.module.scss'
...
export default function InputBarRoom({ getRoom = () => {}, campground_id }) {
  const {
    searchValue = {},
    handleFieldChange = () => {},
    calenderValue = '',
  ...
  return (
    <>
      <div className={styles.groupWrapper}>
        ...
        <button className={styles.searchWrapper} onClick={notifySearch}>
