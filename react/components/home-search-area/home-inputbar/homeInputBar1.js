...
import styles from './homeInputBar1.module.scss'
...
import CalculatePeople from '@/components/inputbar/calculate-people'
    ...
    <>
      ...
      <div className={styles.container}>
        <div className={styles.inputGroup}>
          <div className={`${styles.wrapper} ${styles.mobiShow}`}>
