...
const OrderResultURL = 'http://localhost:3005/api/rent_ecpay/result'
const ReactClientBackURL = 'http://localhost:3000/rent_cart/finish'
...
router.get('/payment', async (req, res, next) => {
  ...
  const ItemName = '訂單編號' + orderRecord.order_id + '商品一批'
